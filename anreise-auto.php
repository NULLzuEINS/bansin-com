...
WEB.DE</a> die Mˆglichkeit, Ihre Fahrtroute direkt von Ihrem "Heimathafen" erstellen und anschliessend ausdrucken zu lassen.
...
<tr>
    ...
    <tr>
        ...
        <td colspan="2" width="180"><font face="Verdana, Arial, Helvetica" size="3"><input type="TEXT" name="fromstreet" value="Straﬂe" size="12" style="width: 178px" tabindex="1" onfocus="javascript:if (document.webderoute2.fromstreet.value == 'Straﬂe') document.webderoute2.fromstreet.value = '';"></font></td>
        <td rowspan="3" width="1"></td>
    </tr>
    <tr>
    ...
    <tr>
        <td colspan="2"><font face="Verdana, Arial, Helvetica" size="2"><select name="fromcountry" tabindex="4" style="width: 178px">
            ...
            <option value="GBR">Groﬂbritannien</option>
    ...
    <tr><td><font face="Verdana, Arial, Helvetica" size="2"><input type="hidden" name="tostreet" value="Badstraﬂe 18">Badstraﬂe 18</font></td></tr>
...
<!-- AUTO HIMMELSRICHTUNG -->
      ...
      <table border="0" cellpadding="0" cellspacing="0" width="435">
      <tr>
      <td width="435" bgcolor="#3399cc" class="headlines"><font color="#ffffff">Straﬂenanbindung</font></td>
      </tr>
      </table>
 <?PHP $sueden= '
...
?>
                                  ...
                                  <TD vAlign=top width="45%"><div align="right">
                                      <br><br><a  href="#" onclick="fenster('bilder/karte-usedom.gif','Karte von Usedom','Beachten Sie bei der Fahrt nach Usedom bitte die Br¸ckenˆffnungszeiten.')" ><img src="bilder/karte-usedom.gif" alt="Ihre Ferienwohnung ist rot markiert" width="100" hspace="5" border=0></a><br>
                                        <br>
