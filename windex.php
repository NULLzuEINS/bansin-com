...
<table cellSpacing=0 cellPadding=0 width="100%" border=0>
    ...
    <TR>
        ...
        if (($currentDay >= $HauptEinsVon && $currentDay <= $HauptEinsBis) || 
            ($currentDay >= $HauptZweiVon && $currentDay <= $HauptZweiBis) || 
            ($currentDay >= $HauptDreiVon && $currentDay <= $HauptDreiBis)) {
        ...
        if (($currentDay >= $ZwischenEinsVon && $currentDay <= $ZwischenEinsBis) || 
            ($currentDay >= $ZwischenZweiVon && $currentDay <= $ZwischenZweiBis)) {
        ...
        if (($currentDay >= $VorEinsVon && $currentDay <= $VorEinsBis) || 
            ($currentDay >= $VorZweiVon && $currentDay <= $VorZweiBis)) {
