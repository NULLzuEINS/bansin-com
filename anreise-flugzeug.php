...
<!-- AUTO HIMMELSRICHTUNG -->
      ...
      <tr>
      <td width="435" bgcolor="#3399cc" class="headlines"><font color="#ffffff">Flughafen Zirchow</font></td>
      </tr>
      </table>


 <table cellspacing="0" cellpadding="5" width="435" bgcolor="#f0f0f0">

            <tr bgcolor="#f0f0f0">
            <td width="350"  bgcolor="#f0f0f0" class="erlaeuterung">
...
<br>
      ...
      Als Flugtage sind der Samstag und der Dienstag vorgesehen.
		...
		<li><b>Bedarfscharter</b><br>Bedarfslinienfl�ge <br>
			...
			<ul><li><b>Privater Flugverkehr</b><br>
			Hier k&ouml;nnen Sportflugzeuge starten und landen.
			</ul>
          <ul>Auf dem Flugplatz in Peenem&uuml;nde mit einer
          Landebahn von 1300 m sind nur Sportflieger zugelassen.
        </ul>
        </td></tr></table>
