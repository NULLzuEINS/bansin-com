           ...
           <tbody>
             ...
             <tr bgcolor="#ffffff">
                 ...
                 <table border="0" cellpadding="0" cellspacing="0" width="435">
                   ...
                   <tr bgcolor="#EBECEE">
                     <td width="10" rowspan="4">
                       <form name="webderoute2" method="post" target="webde" action="http://portale.web.de/Auto/Routenplaner/"><img src="http://img.web.de/v/p.gif" border="0" width="10" height="1" alt="">
                     </td>
                   ...
                   <tr>
                       ...
                       <table border="0" cellpadding="2" cellspacing="2" width="198">
                         <tr>
                           ...
                           <td colspan="2" width="180">
                             <font face="Verdana, Arial, Helvetica" size="3"><input type="TEXT" name="fromstreet" value="Straï¿½e" size="12" style="width: 178px" tabindex="1" onfocus="javascript:if (document.webderoute2.fromstreet.value == 'Straï¿½e') document.webderoute2.fromstreet.value = '';"></font>
                           </td>
                           <td rowspan="3" width="1"></td>
                         </tr>
                         <tr>
                           <td width="58">
                             <font face="Verdana, Arial, Helvetica" size="3"><input type="TEXT" name="fromplz" value="PLZ" size="3" style="width: 50px" maxlength="10" tabindex="2" onfocus="javascript:if (document.webderoute2.fromplz.value == 'PLZ') document.webderoute2.fromplz.value = '';"></font>
                           </td>
                           <td width="118">
                             <font face="Verdana, Arial, Helvetica" size="3"><input type="TEXT" name="fromcity" value="Ort" size="8" style="width: 120px" tabindex="3" onfocus="javascript:if (document.webderoute2.fromcity.value == 'Ort') document.webderoute2.fromcity.value = '';"></font>
                           </td>
                         </tr>
                         <tr>
                           <td colspan="2">
                             <font face="Verdana, Arial, Helvetica" size="2"><select name="fromcountry" tabindex="4" style="width: 178px">
                     ...
                     <td align="center" valign="middle" bgcolor="#FFFFFF" width="198">
                       <table border="0" cellpadding="2" cellspacing="2" width="198">
                         ...
                         <tr>
                           <td>
                             <font face="Verdana, Arial, Helvetica" size="2"><input type="hidden" name="tostreet" value="Schulstraï¿½e 7">Schulstraï¿½e 7</font>
                           </td>
                         </tr>
                         <tr>
                           <td>
                             <font face="Verdana, Arial, Helvetica" size="2"><input type="hidden" name="tocountry" value="DEU"><input type="hidden" name="toplz" value="17429"><input type="hidden" name="tocity" value="Seebad Bansin">D - 17429 Seebad Bansin</font>
                           </td>
                         </tr>
                       </table>
                     </td>
               ...
               <td>
                 ...
                 <input type="submit" name="submitButtonName" value="Suchen" border="0" style="font-family:verdana,helvetica,arial,sans-serif;font-size:8pt;color: #ffffff; width:65px;border-color:#ffffff;background-color:#3399cc;border-width:1;border-style:solid">&nbsp;
               </td>
       </td>
     </tr>
 </table>
