  ...
  if ($ZielTag == "" || $ZielMonat == "" || $ZielJahr == "" )
    ...
    echo "<p><b>SchaltJahr: ". $SchaltJahr  ."</b><p>";
              ...
              if( ($JahresTag >= $HauptEinsVon && $JahresTag <= $HauptEinsBis ) || ($JahresTag >= $HauptZweiVon && $JahresTag <= $HauptZweiBis )|| ($JahresTag >= $HauptDreiVon && $JahresTag <= $HauptDreiBis ))
                   {
                    echo "Zur Zeit ist Hauptsaison. Sie können sich bei uns in der Villa Cosima
                          für nur 75€ am Tag einmieten und wundervolle Momente in Bansind und auf Usedom erleben.";
                }
              if( ($JahresTag >= $ZwischenEinsVon && $JahresTag <= $ZwischenEinsBis ) || ($JahresTag >= $ZwischenZweiVon && $JahresTag <= $ZwischenZweiBis ))
                   {
                    echo "Zur Zeit ist Zwischensaison. Sie können sich bei uns in der Villa Cosima
                          für nur <b>55€</b> am Tag einmieten und wundervolle Momente in Bansind und auf Usedom erleben.";
                }
              if( ($JahresTag >= $VorEinsVon && $JahresTag <= $VorEinsBis ) || ($JahresTag >= $VorZweiVon && $JahresTag <= $VorZweiBis ) )
                   {
                    echo "Zur Zeit haben wir die Vorsaison. Das
                                            ...
                                            sie gesenkt. Sie können sich bei uns in der Villa Cosima
                          für nur <b>41€</b> am Tag einmieten und wundervolle Momente in Bansin und auf Usedom erleben.";
                }
